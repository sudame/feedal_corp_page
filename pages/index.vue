...
<!--    mission 画面-->
    <div id="mission">
      ...
      <div class="content">
        ...
        ー 混沌とする情報から自分の欲しい情報だけを手に入れることが難しい ー<br><br>
        ー 世の中の流行の遷移が速すぎてついていけない ー<br><br>
        そんな経験ありませんか？<br><br><br>
        私たちFeedal は、<br><br>
        このような課題を解決すべく、<br><br>
          “より良い情報をすばやく手に入れられる” インプットのインフラを作ります。</p>
      </div>
...
<!--    service 画面-->
    <div id="service">
      ...
      <div class="content">
        ...
        他ユーザーを通じて、常に最新で有意義な情報を得ることでエンジニアのあなたのインプットを充実させます。
      </div>
